...
import { getAppItems, getCustomMenus, getFabs, getPersonalSettings, getRoles, savePersonalSettings } from '../config.js?v=20260728';


import { hideModalSafely, showModalSafely } from './modal-utils.js?v=20260728';
import { batchSaveMenusAPI, deleteAppAPI, fetchInitialDataFromDB, saveAppAPI, syncDataToDB } from '../api.js?v=20260728';
import { initDashboardUI } from '../main.js?v=20260728';
import { renderSidebarMenus } from '../render/sidebar.js?v=20260728';
import { renderAppGrid, renderMenuConfigTable, renderPersonalMenuManage, renderWebpageTable } from '../render/tables.js?v=20260728';
import { customAlert, customConfirm, updateSyncButtonUI } from '../ui/dialogs.js?v=20260728';
import { navTo } from '../ui/navigation.js?v=20260728';
